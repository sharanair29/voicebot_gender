...
setwd("/Users/hlabs/Desktop/hoop/voicebot/gendervoice/")

data = data.frame("recording1.wav", 0, 0, 20)
names(data) <- c('sound.files', 'selec', 'start', 'end')

acoustics <- specan3(data, parallel=1)
write.csv(acoustics, file = "/Users/hlabs/Desktop/hoop/voicebot/gendervoice/test.csv")
